...
#define _nstates1	13	/* observateur */
#define minseq1	140
#define maxseq1	151
#define _endstate1	12

#define _nstates0	141	/* labyrinthe */
#define minseq0	0
#define maxseq0	139
...
#define Air1	(sizeof(P1) - Offsetof(P1, direction) - 1*sizeof(uchar))
